...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Admission Quota</h3>
        <div class="card-tools">
          <a class="btn btn-primary" href="{{ route('admission_quota.create')}}">New Item</a>
        </div>
    </div>
    <div class="card-body">
                      ...
                      <div class="btn-group btn-group-sm">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <div class="dropdown-divider"></div>
                            <a href="{{route('admission_quota.edit',$item->id)}}" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>
                            <div class="dropdown-divider"></div>
                            <form class="delete" action="{{ route('admission_quota.destroy',$item->id) }}" method="post">
                              {{ csrf_field() }}
                              {{ method_field('DELETE') }}
